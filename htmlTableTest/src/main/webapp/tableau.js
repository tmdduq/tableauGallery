        ...
        o = function() {
            var f = function(n) {
                    ...
                    if (Object.defineProperty(this, "_entries", {
                            writable: !0,
                            value: {}
                        }), r = typeof n, r !== "undefined")
                        if (r === "string") n !== "" && this._fromString(n);
                        else if (n instanceof f) e = this, n.forEach(function(n, t) {
                        e.append(t, n)
                    });
                    else if (n !== null && r === "object")
                        if (Object.prototype.toString.call(n) === "[object Array]")
                            for (t = 0; t < n.length; t++)
                                if (i = n[t], Object.prototype.toString.call(i) === "[object Array]" || i.length !== 2) this.append(i[0], i[1]);
                                else throw new TypeError("Expected [string, any] as entry at index " + t + " of URLSearchParams's input");
                    else
                        for (u in n) n.hasOwnProperty(u) && this.append(u, n[u]);
            ...
            t.forEach = function(n, t) {
                ...
                for (i in this._entries)
                    if (this._entries.hasOwnProperty(i))
                        for (u = this._entries[i], r = 0; r < u.length; r++) n.call(t, u[r], i, this)
            };
            t.keys = function() {
                var n = [];
    ...
    typeof t._fromString != "function" && Object.defineProperty(t, "_fromString", {
        ...
        value: function(n) {
            ...
            if (this._entries) this._entries = {};
                ...
                for (i = [], this.forEach(function(n, t) {
                        i.push(t)
